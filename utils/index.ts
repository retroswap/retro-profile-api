...
export const PROFILE_SUBGRAPH = "https://api.thegraph.com/subgraphs/name/retroswap/profile";

/**
 * Check for the validity of a username based on rules (see documentation).
 *
 * @see https://github.com/retroswap/retro-profile/blob/master/user-stories.md#step-4-username-creation
 *
